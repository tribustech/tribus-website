...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A mental-health support app for people living with PTSD. It pairs symptom tracking with guided coping tools — a distress meter, muscle-relaxation and meditation sessions, and inspirational content — so users can find the right instrument for whatever they're feeling in the moment.",
    platforms: ["Mobile"],
    industry: "Health & Wellness",
    tech: ["React Native", "NestJS", "PostgreSQL"],
    accent: "blue",
